...
class NewsService {
  ...
  static const String baseUrl = 'ADD-YOUR-URL-HERE-FOR-AGENT-SERVER';
  String? _token;

  Future<void> login() async {
    try {
      print('🔑 News Service: Attempting login...');
      print('🔑 News Service: URL: $baseUrl/api/login');
      ...
      print('🔑 News Service: Response status code: ${response.statusCode}');
      print('🔑 News Service: Response headers: ${response.headers}');
      print('🔑 News Service: Response body: ${response.body}');
      ...
      print('❌ News Service: Error type: ${e.runtimeType}');
      if (e is http.ClientException) {
        print('❌ News Service: Client exception details: ${e.message}');
      }
